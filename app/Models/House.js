...
get house_template(){
  ...
  <div class="card">
    <img src="${this.imgUrl}" class="card-img-top"
      alt="House">
    <div class="card-body">
      <div class="card-title fs-5">Bedrooms:${this.bedrooms}, Bathrooms: ${this.bedrooms}, Floors: ${this.floors}</div>
      ...
      <button data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn ms-1 btn-info" type="button" onclick="app.houseController.draw_form('${this.id}')">Edit House</button>
      </div>
      </div>
  </div>
</div>
